...
; x is the average of f(x - dx), f(x), and f(x + dx). Write a procedure smooth that takes as input a
...
; and so on) to obtained the n-fold smoothed function. Show how to generate the n-fold smoothed
